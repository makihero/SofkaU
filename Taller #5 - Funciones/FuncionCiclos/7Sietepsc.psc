SubProceso parqueadero ( n1,n2,n3,n4,n5,p1,p2,p3,p4,p5,m1,m2,m3,m4,m5,t1,t2,t3,t4,t5, usuario, consulta, retiro, vacio, op, i, conteo )
	Repetir
...
Proceso funParqueadero 
	...
	n1<-'';n2<-'';n3<-'';n4<-'';n5<-'';p1<-'';p2<-'';p3<-'';p4<-'';p5<-'';m1<-'';m2<-'';m3<-'';m4<-'';m5<-'';t1<-'';t2<-'';t3<-'';t4<-'';t5<-'';usuario<-'';consulta<-'';retiro<-'';vacio<-'sin datos';
	op<-0;i<-0;
	conteo <- Verdadero;
	
	parqueadero(n1,n2,n3,n4,n5,p1,p2,p3,p4,p5,m1,m2,m3,m4,m5,t1,t2,t3,t4,t5, usuario, consulta, retiro, vacio, op, i,conteo);

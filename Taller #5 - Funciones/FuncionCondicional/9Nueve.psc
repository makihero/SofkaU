SubProceso areaFiguras ( base, base1, altura, areaRectangulo, areaTriangulo, areaTrapecio, op )
...
Proceso funFiguras
	...
	base<-0;base1<-0;altura<-0;areaRectangulo<-0;areaTriangulo<-0;areaTrapecio<-0;op<-0;
	areaFiguras(base, base1, altura, areaRectangulo, areaTriangulo, areaTrapecio, op);	
